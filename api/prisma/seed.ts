...
// // const main = async () => {
// //   try {
// //     // Create StoreTypes first
// //     const branch1 = await prisma.storeType.create({
// //       data: { name: "Branch 1" },
// //     });
// //     const branch2 = await prisma.storeType.create({
// //       data: { name: "Branch 2" },
// //     });

// //     // Create a Store with existing StoreTypes
// //     const store = await prisma.store.create({
// //       data: {
// //         name: "Store 2",
// //         storeTypes: {
// //           connect: [{ id: branch1.id }, { id: branch2.id }],
// //         },
// //       },
// //     });
...
// //         email: "test@mail.com",
// //         password:
// //           "$2a$10$zqgAMD5bVH5nnaN0NV7V6eYUjweRi4I7h1am3GpIwCAYrnWCuG4vO",
// //         unity_id: store.id,
// //         position: "Administration",
// //         permissions:
// //           "view_dashboard,view_financial,create_carrier,view_carrier,update_carrier,delete_carrier,create_category,view_category,update_category,delete_category,create_client,view_client,update_client,delete_client,create_register,view_register,update_register,delete_register,create_product,view_product,update_product,delete_product,create_provider,view_provider,update_provider,delete_provider,create_purchase,view_purchase,update_purchase,delete_purchase,create_sale,view_sale,update_sale,delete_sale,create_seller,view_seller,update_seller,delete_seller,create_store,view_store,update_store,delete_store,create_ticket,view_ticket,update_ticket,delete_ticket,create_user,view_user,update_user,delete_user,restrict_delete_store,",
...
//     // Create Branches with reference to the Store
...
//     console.log("Store Created:", store);
//     console.log("Branches Created:", branch1, branch2);
...
const main = async () => {
  try {
    ...
    // Create a Store with reference to the Branch
    const store = await prisma.store.create({
      data: {
        name: "Store 2",
        branchId: branch.id, // Set the branchId to associate the store with the branch
      },
    });
    ...
    // Create another Branch and a Store associated with it
    ...
    const store2 = await prisma.store.create({
      data: {
        name: "Store 3",
        branchId: branch2.id, // Associate the store with the new branch
      },
    });

    console.log("Branch Created:", branch2);
    console.log("Store Created:", store2);
    ...
    const user = await prisma.user.create({
      data: {
        ...
        password:
          "$2a$10$zqgAMD5bVH5nnaN0NV7V6eYUjweRi4I7h1am3GpIwCAYrnWCuG4vO",
        unity_id: store.id, // Link the user to the store
        position: "Administration",
        permissions:
          "view_dashboard,view_financial,create_carrier,view_carrier,update_carrier,delete_carrier,create_category,view_category,update_category,delete_category,create_client,view_client,update_client,delete_client,create_register,view_register,update_register,delete_register,create_product,view_product,update_product,delete_product,create_provider,view_provider,update_provider,delete_provider,create_purchase,view_purchase,update_purchase,delete_purchase,create_sale,view_sale,update_sale,delete_sale,create_seller,view_seller,update_seller,delete_seller,create_store,view_store,update_store,delete_store,create_ticket,view_ticket,update_ticket,delete_ticket,create_user,view_user,update_user,delete_user,restrict_delete_store,",
        active: true,
