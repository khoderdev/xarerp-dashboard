...
//     dispatch({
//       type: 'MODALREGISTERS_SET_REGISTEREDITINGID',
//       payload: { registerEditingId: item.id }
//     });
//     dispatch({
//       type: 'MODALREGISTERS_SET_EDITINGREGISTER',
//       payload: { editingRegister: true }
//     });
//     dispatch({
//       type: 'REGISTER_CHANGE_PROPS',
//       payload: { props: { ...item } }
...
//         ) : e.key === 'branch' ? (
//           <C.TableColumn key={i}>
//             {item.branches ? item.branches.map(branch => branch.name).join(', ') : 'No Branches'}
//           </C.TableColumn>
//         ) : (
//           <C.TableColumn key={i}>{item[e.key]}</C.TableColumn>
//         )
    ...
    <C.TableLine>
      {state.tableRegisters.heads.map((e, i) => (
        e.key === 'actions' ? (
          ...
          <C.TableColumn key={i}>
            {item.branch ? item.branch.name : 'No Branch'}
          </C.TableColumn>
        ) : (
          <C.TableColumn key={i}>{item[e.key]}</C.TableColumn>
        )
